...
% Last Modified by GUIDE v2.5 10-Ene-2021 23:36:24
...
grid
title(handles.Pre,'Presión Atmósfera Isoentrópica (Mercurio)','color','w')
...
grid
title(handles.Temp,'Temperatura Atmósfera Isoentrópica (Mercurio)','color','w')
...
grid
title(handles.Dens,'Densidad Atmósfera Isoentrópica (Mercurio)','color','w')
